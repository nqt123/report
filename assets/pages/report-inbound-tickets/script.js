...
var DFT = function ($) {
    ...
    function bindClick() {
        ...
        $(document).on('click', '#download-excel', function () {
            queryFilter('frm-report-inbound-ticket', true, true, lastPagingData['frm-report-inbound-ticket'].totalResult);
        });
    ...
    return {
        ...
        uncut: function () {
            ...
            delete _socket.$events['responseReportInboundTicketPagingData'];
        }
    };
}(jQuery);