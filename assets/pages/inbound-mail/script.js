/**
 * Created by luongvanlam on 4/22/16.
 */
var DFT = function ($) {
    ...
    var bindSocket = function (client) {
        ...
        client.on('responseTicketInboundMailPagingData', function (resp) {
    ...
    var bindClick = function () {
        ...
        // Sửa dữ liệu trực tiếp từ giao diện
        ...
        // Sửa dữ liệu ticket trực tiếp từ giao diện
    ...
    // Lấy dữ liệu tìm kiếm và truy vấn
    ...
    var loadData = function (formId, resp) {
        ...
        var activeTDTemplate =
            ...
            'href="#ticket-mail-edit?ticketID={0}" ' +
            'data-toggle="tooltip"' +
            'data-placement="top" data-original-title="Sửa Ticket">' +
            '<i class="zmdi zmdi-edit c-green f-17"></i></a>' +
            '<a class="p-t-3 btn-flat-bg open-mail" ' +
            'data-tid="{0}" ' +
            'data-toggle="tooltip"' +
            'data-placement="top" data-original-title="Xem nội dung email">' +
            '<i class="zmdi zmdi-y c-green f-17"></i></a>';
        ...
        resp.message.forEach(function (el) {
            ...
            rows += template.str(el.company,
                ...
                el.note,
                activeTDTemplate.str(el._id, el.field_e_mail, el._id),
                inlineEditButton,
    ...
    return {
        ...
        uncut: function () {
            // disable trạng thái khi đóng trang
            notProcessLastSearch = {};
            allTicketLastSearch = {};
            pagingObject = {};
            lastPagingData = {};
            makeCallData = {};
            delete _socket.$events['responseTicketInboundMailPagingData'];
